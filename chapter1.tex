...
% A valid hotspot algorithm? You've not actually described what this algorithm will do other than imply it through your reference to it as a 'hotspot algorithm' (I'm being picky)
...
% So you've only used simple algorithms? Why? ( I know this isn't really what you mean, just how it may be read)There are no hard to understand, advanced computer science algorithms or techniques used in this project. However, 
...
% again, rephrasing to avoid "I" would lend you a more professional feel. "The next section will discuss the structure... ...Afterwards, the reader will find.... ...where there is some detail of the..."
